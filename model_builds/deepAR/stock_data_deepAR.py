...
file_path = "/Users/charlesmiller/Documents/Code/gluonts/model_builds/data/full.csv"
...
print(f"Train Symbols: {train_df['symbol'].nunique()}")
print(f"Validation shape: {validation_df.shape}")
print(f"Validation Symbols: {validation_df['symbol'].nunique()}")
print(f"Test shape: {test_df.shape}")
print(f"Test Symbols: {test_df['symbol'].nunique()}")
